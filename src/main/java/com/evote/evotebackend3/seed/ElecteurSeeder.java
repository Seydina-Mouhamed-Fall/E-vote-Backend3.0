...
public class ElecteurSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        System.out.println("⚙️ ElecteurSeeder démarré...");

        Electeur electeur1 = new Electeur(
            "Ndour", "Youssou", "You02@gmail.com", "motdepasse123", LocalDate.now(),
            "771236564", true, false, "CNI123456670"
        );

        Electeur electeur2 = new Electeur(
            "Fall", "Saliou", "Saliou2006@gmail.com", "Salioupass", LocalDate.now(),
            "781234663", true, false, "CNI927754301"
        );
        ...
        Electeur electeur11 = new Electeur(
            "Diallo", "Mamadou", "mamadou.diallo@gmail.com", "diallo123", LocalDate.now(), "761234569", true, false, "CNI000000011"
        );
